...
class GantiPasswordGuruActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ganti_password_guru)
        ...
        if (TextUtils.isEmpty(userPwdNew)) {
            ...
            firebaseUser.updatePassword(userPwdNew).addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    ...
                    val intent = Intent(this, ProfilGuruFragment::class.java)
