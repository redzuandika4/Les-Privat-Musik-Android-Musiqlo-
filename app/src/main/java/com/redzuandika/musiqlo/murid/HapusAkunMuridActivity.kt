...
class HapusAkunMuridActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_hapus_akun_murid)
    ...
    private fun deleteUserData() {
        ...
        val databaseReference: DatabaseReference = FirebaseDatabase.getInstance().getReference("murid")
        ...
        if (photoUrl != null) {
            ...
            if (photoReference.path.startsWith("foto_siswa/")) {
